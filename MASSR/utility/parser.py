...
def parse_args():
    ...
    #train
    parser.add_argument('--data_path', nargs='?', default='/root/autodl-tmp/MASSR-main/MASSR/data/', help='Input data path.')
    parser.add_argument('--seed', type=int, default=2022, help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='', help='Choose a dataset from {amazone, tiktok, allrecipes}')
    parser.add_argument('--epoch', type=int, default=1000, help='Number of epoch.')  #default:
    ...
    parser.add_argument('--sn_rate', type=float, default=0.03, help='Control the effect of the contrastive auxiliary task')
    ...
    parser.add_argument('--elastic_net_alpha', default=0.01, type=float, help='alpha')  #
    parser.add_argument('--elastic_net_lambda', default=1.0, type=float, help='lambda')  #
